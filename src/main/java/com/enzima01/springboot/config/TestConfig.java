...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2025-02-14T19:53:07Z"), u1);
		Order o2 = new Order(null, Instant.parse("2025-06-22T03:42:10Z"), u2);
		Order o3 = new Order(null, Instant.parse("2026-01-20T15:21:22Z"), u1);
		Order o4 = new Order(null, Instant.parse("2026-02-04T15:21:22Z"), u2);
